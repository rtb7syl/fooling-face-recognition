...
class FaceXZooProjector(nn.Module):
    ...
    def align_patch(self, adv_patch, landmarks):
        ...
        cropped_image = kornia.geometry.transform.remap(cropped_image, map_x=grid[..., 0], map_y=grid[..., 1], mode='nearest')
...
class PRN:
    ...
    def preprocess(self, img_batch, image_info):
        ...
        tform = kornia.geometry.get_perspective_transform(src_pts, dst_pts)
