...
from optimizers import SimpleSGD, Adam
...
class AdversarialMask:
    def __init__(self, config):
        ...
        self.meta_optimizer = Adam(device)
    ...
    def forward_step(self, img_batch, adv_patch_cpu, cls_id):
        ...
        for i, (embedder_name, emb_model) in enumerate(self.embedders.items()):
            ...
            if i != test_embedder_idx:
                ...
                adv_patch_updated = self.meta_optimizer.step(objective=adv_patch, gradient=tr_loss_grad_adv)
