...
command += "--account lect0083 -t 6:00:00 --mem 30G -c 15 --gres gpu:1 --partition c16g " + home+"testscript_train.sh "+"--mail-type begin --mail-type end --mail-type fail --mail-user "+mail_id
