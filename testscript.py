...
command += "--account lect0083 -t 2:00:00 --mem 50G -c 8 --gres gpu:1 --partition c16g " + home+"testscript.sh "+"--mail-type begin --mail-type end --mail-type fail --mail-user "+mail_id
